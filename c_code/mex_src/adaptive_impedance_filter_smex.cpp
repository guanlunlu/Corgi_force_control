#define S_FUNCTION_NAME adaptive_impedance_filter_smex /* Defines and Includes */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Eigen::Matrix2d K_f{{*uPtrs[36], 0},
                        {0, *uPtrs[37]}};

    Eigen::Matrix2d K_v{{*uPtrs[38], 0},
                        {0, *uPtrs[39]}};

    Eigen::Vector2d Xc_k = AdaptiveImpedanceFilter(M, K, D, X_des, F_ref, X_c, TB_fb, T_fb, K_f, K_v);
