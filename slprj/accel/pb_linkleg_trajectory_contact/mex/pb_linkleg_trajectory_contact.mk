...
MODEL                   = pb_linkleg_trajectory_contact
MODULES                 = pb_linkleg_trajectory_contact_acc.c pb_linkleg_trajectory_contact_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/pb_linkleg_trajectory_contact_acc.mexa64
MAKEFILE                = pb_linkleg_trajectory_contact.mk
...
MODELLIB                  = pb_linkleg_trajectory_contact_acc.mexa64
MODELREF_LINK_LIBS        = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/pb_linkleg_trajectory_contact \
...
pb_linkleg_trajectory_contact_acc.o : $(START_DIR)/slprj/accel/pb_linkleg_trajectory_contact/pb_linkleg_trajectory_contact_acc.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/pb_linkleg_trajectory_contact/pb_linkleg_trajectory_contact_acc.c

pb_linkleg_trajectory_contact_acc_data.o : $(START_DIR)/slprj/accel/pb_linkleg_trajectory_contact/pb_linkleg_trajectory_contact_acc_data.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/pb_linkleg_trajectory_contact/pb_linkleg_trajectory_contact_acc_data.c

rtGetInf.o : $(START_DIR)/slprj/accel/pb_linkleg_trajectory_contact/rtGetInf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/pb_linkleg_trajectory_contact/rtGetInf.c

rtGetNaN.o : $(START_DIR)/slprj/accel/pb_linkleg_trajectory_contact/rtGetNaN.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/pb_linkleg_trajectory_contact/rtGetNaN.c

rt_nonfinite.o : $(START_DIR)/slprj/accel/pb_linkleg_trajectory_contact/rt_nonfinite.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/pb_linkleg_trajectory_contact/rt_nonfinite.c
