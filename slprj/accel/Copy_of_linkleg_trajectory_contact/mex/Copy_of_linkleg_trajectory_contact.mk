...
MODEL                   = Copy_of_linkleg_trajectory_contact
MODULES                 = Copy_of_linkleg_trajectory_contact_acc.c Copy_of_linkleg_trajectory_contact_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/Copy_of_linkleg_trajectory_contact_acc.mexa64
...
SYSTEM_LIBS             = -L"/home/matlab/bin/glnxa64" -lmwipp -lut -lmwmathutil -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwsl_fileio -lmwsigstream -lmwslexec_simlog -lmwsl_AsyncioQueue -lmwsf_runtime -lmwsimulink -lmwslexec_simbridge -lmwstringutil -lemlrt -lmwslio_core -lmwslio_clients -lmwsl_services -lmx -lmex
...
MODELLIB                  = Copy_of_linkleg_trajectory_contact_acc.mexa64
MODELREF_LINK_LIBS        = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/Copy_of_linkleg_trajectory_contact \
...
Copy_of_linkleg_trajectory_contact_acc.o : $(START_DIR)/slprj/accel/Copy_of_linkleg_trajectory_contact/Copy_of_linkleg_trajectory_contact_acc.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Copy_of_linkleg_trajectory_contact/Copy_of_linkleg_trajectory_contact_acc.c

Copy_of_linkleg_trajectory_contact_acc_data.o : $(START_DIR)/slprj/accel/Copy_of_linkleg_trajectory_contact/Copy_of_linkleg_trajectory_contact_acc_data.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Copy_of_linkleg_trajectory_contact/Copy_of_linkleg_trajectory_contact_acc_data.c

rtGetInf.o : $(START_DIR)/slprj/accel/Copy_of_linkleg_trajectory_contact/rtGetInf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Copy_of_linkleg_trajectory_contact/rtGetInf.c

rtGetNaN.o : $(START_DIR)/slprj/accel/Copy_of_linkleg_trajectory_contact/rtGetNaN.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Copy_of_linkleg_trajectory_contact/rtGetNaN.c

rt_nonfinite.o : $(START_DIR)/slprj/accel/Copy_of_linkleg_trajectory_contact/rt_nonfinite.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Copy_of_linkleg_trajectory_contact/rt_nonfinite.c
